...
extern "C" {
    fn tree_sitter_gamma2() -> *const ();
}

pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_gamma2) };
...
mod tests {
    ...
    fn parses_small_accepted_inputs_without_errors() {
        ...
        parser
            ...
            .expect("Error loading gamma2 parser");

        for source in ["bbba", "bbbbba"] {
